...
template bool signatures::verify_txns<zera_txn::SelfCurrencyEquiv>(zera_txn::SelfCurrencyEquiv &);
template bool signatures::verify_txns<zera_txn::AuthorizedCurrencyEquiv>(zera_txn::AuthorizedCurrencyEquiv &);
...
template bool signatures::verify_txns<zera_txn::FoundationTXN>(zera_txn::FoundationTXN &);
