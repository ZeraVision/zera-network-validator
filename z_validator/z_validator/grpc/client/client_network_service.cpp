...
grpc::Status ClientNetworkServiceImpl::CurrencyEquiv(grpc::ServerContext *context, const zera_txn::SelfCurrencyEquiv *request, google::protobuf::Empty *response)
{
    return RecieveRequest(context, request, response);
}
grpc::Status ClientNetworkServiceImpl::AuthCurrencyEquiv(grpc::ServerContext *context, const zera_txn::AuthorizedCurrencyEquiv *request, google::protobuf::Empty *response)
{
    return RecieveRequest(context, request, response);
}
...
grpc::Status ClientNetworkServiceImpl::Foundation(grpc::ServerContext *context, const zera_txn::FoundationTXN *request, google::protobuf::Empty *response)
{
    return RecieveRequest(context, request, response);
}
