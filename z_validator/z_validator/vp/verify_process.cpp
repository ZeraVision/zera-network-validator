...
template ZeraStatus verify_txns::verify_txn<zera_txn::SelfCurrencyEquiv>(const zera_txn::SelfCurrencyEquiv *txn);
template ZeraStatus verify_txns::verify_txn<zera_txn::AuthorizedCurrencyEquiv>(const zera_txn::AuthorizedCurrencyEquiv *txn);
...
template ZeraStatus verify_txns::verify_txn<zera_txn::FoundationTXN>(const zera_txn::FoundationTXN *txn);
...
template <>
void verify_txns::store_wrapper<zera_txn::SelfCurrencyEquiv>(const zera_txn::SelfCurrencyEquiv *txn, zera_txn::TXNWrapper &wrapper)
{
    wrapper.mutable_self_cur_equivs()->CopyFrom(*txn);
    wrapper.set_txn_type(zera_txn::TRANSACTION_TYPE::SELF_CURRENCY_EQUIV_TYPE);
}

template <>
void verify_txns::store_wrapper<zera_txn::AuthorizedCurrencyEquiv>(const zera_txn::AuthorizedCurrencyEquiv *txn, zera_txn::TXNWrapper &wrapper)
{
    wrapper.mutable_auth_cur_equivs()->CopyFrom(*txn);
    wrapper.set_txn_type(zera_txn::TRANSACTION_TYPE::AUTHORIZED_CURRENCY_EQUIV_TYPE);
}
...
template <>
void verify_txns::store_wrapper<zera_txn::FoundationTXN>(const zera_txn::FoundationTXN *txn, zera_txn::TXNWrapper &wrapper)
{
    wrapper.mutable_foundation_txn()->CopyFrom(*txn);
    wrapper.set_txn_type(zera_txn::TRANSACTION_TYPE::FOUNDATION_TYPE);
}
template <>
