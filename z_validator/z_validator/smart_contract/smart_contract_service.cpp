...
WasmEdge_ModuleInstanceContext *CreateExternModule()
{
  ...
  enum WasmEdge_ValType ParamList_TransferV2[7] = {WasmEdge_ValType_I32, WasmEdge_ValType_I32, WasmEdge_ValType_I32, WasmEdge_ValType_I32, WasmEdge_ValType_I32, WasmEdge_ValType_I32, WasmEdge_ValType_I32};
  enum WasmEdge_ValType ReturnList_TransferV2[1] = {WasmEdge_ValType_I32};
  CreateHostFunction(HostModCxt,
                     ParamList_Transfer, sizeof(ParamList_Transfer) / sizeof(ParamList_Transfer[0]),
                     ReturnList_Transfer, sizeof(ReturnList_Transfer) / sizeof(ReturnList_Transfer[0]),
