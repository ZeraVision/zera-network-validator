...
namespace
{
    ...
    std::vector<zera_txn::TXNWrapper> order_nonce_txns(std::vector<zera_txn::TXNWrapper> wrappers)
    {
        ...
        for (auto wrapper : wrappers)
        {
            ...
            {
                nonce_pairs.push_back(std::make_pair(wrapper.auth_cur_equivs().base().nonce(), wrapper));
            }
            else if (wrapper.has_self_cur_equivs())
            {
                nonce_pairs.push_back(std::make_pair(wrapper.self_cur_equivs().base().nonce(), wrapper));
            }
            ...
            {
                nonce_pairs.push_back(std::make_pair(wrapper.foundation_txn().base().nonce(), wrapper));
            }
