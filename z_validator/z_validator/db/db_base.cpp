...
template int db_base<db_foundation_tag>::open_db();
...
template void db_base<db_foundation_tag>::close_db();
...
template int db_base<db_foundation_tag>::get_single(const std::string &key, std::string &value);
...
template int db_base<db_foundation_tag>::exist(const std::string &key);
...
template int db_base<db_foundation_tag>::store_single(const std::string &key, const std::string &value);
...
template int db_base<db_foundation_tag>::remove_single(const std::string &key);
...
template int db_base<db_foundation_tag>::get_all_data(std::vector<std::string> &values, std::vector<std::string> &keys);
...
template int db_base<db_foundation_tag>::remove_all();
...
template int db_base<db_foundation_tag>::compact_all();
...
template int db_base<db_foundation_tag>::backup_database(const std::string &backup_path);
...
template int db_base<db_foundation_tag>::restore_database(const std::string &backup_path);
