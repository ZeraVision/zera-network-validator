...
const char *const db_currency_equiv_1_tag::DB_NAME = "currency_equiv";
const char *const db_expense_ratio_1_tag::DB_NAME = "expense_ratio";
const char *const db_foundation_1_tag::DB_NAME = "foundation";
...
template int migrate_db_base<db_currency_equiv_1_tag>::migrate(std::string &backup_path);
template int migrate_db_base<db_expense_ratio_1_tag>::migrate(std::string &backup_path);
template int migrate_db_base<db_foundation_1_tag>::migrate(std::string &backup_path);
